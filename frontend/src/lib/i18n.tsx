...
const dict: Record<Lang, Record<string, string>> = {
  ...
  bn: {
    ...
    "safety.subtitle": "কোনো এজেন্টকে টাকা দেওয়ার আগে এই ধাপগুলো অনুসরণ করুন।",
    ...
    "dest.title": "সরকার-নির্ধারিত অভিবাসন খরচ ও বেতন",
    "dest.subtitle":
    ...
    "dest.days": "দিন",
    "dest.redflag.SA":
      "'ফ্রি ভিসা' অফার থেকে সতর্ক থাকুন - এগুলো অবৈধ এবং আপনাকে বৈধ মর্যাদা ছাড়াই রেখে দেয়।",
    "dest.redflag.MY":
      "সরকার-নির্ধারিত খরচ ৭৮,৯৯০ টাকা। এর বেশি চাইলে তা অবৈধভাবে অতিরিক্ত আদায় করা হচ্ছে।",
    "dest.redflag.AE":
      "ভিজিট ভিসা সহজে ওয়ার্ক ভিসায় রূপান্তর করা যায় না। টাকা দেওয়ার আগে ভিসার ধরন নিশ্চিত করুন।",
    "dest.redflag.QA":
      "যাত্রার আগে আপনার নিয়োগকর্তার নাম চুক্তির সাথে মেলে কিনা নিশ্চিত করুন।",
    "dest.redflag.SG":
      "আপনাকে একটি SEC (স্কিলস ইভ্যালুয়েশন সার্টিফিকেট) পরীক্ষায় পাস করতে হবে - প্রকৃত চাকরির জন্য এটি প্রয়োজন।",
